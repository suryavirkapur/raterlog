  ...
  return (
    ...
    >
      <Badge size="2" variant="soft">
        LogSnag-style events, now with AI
      </Badge>
    ...
    <Flex direction="column" gapY="6" py="9">
      ...
      >
        ...
        <Text size="4" color="gray" style={{ maxWidth: "400px" }}>
          Everything you need to monitor your product events in real-time, from
  ...
  const plans = [
    {
      name: "Starter",
      price: "$9",
      features: ["Up to 50,000 events", "5 team members", "Basic analytics"],
      highlighted: false,
    },
    {
      name: "Pro",
      ...
      >
        {plans.map((plan, index) => (
          <Card
            ...
            size="3"
            style={
              plan.highlighted ? { border: "2px solid var(--accent-9)" } : {}
            }
          >
            <Flex direction="column" gap="3">
...
function Footer() {
  return (
    ...
    >
      <footer>
        <Text size="2" color="gray">
          &copy; 2024 Raterlog. All rights reserved.
        </Text>
      </footer>
    </Flex>
  );
