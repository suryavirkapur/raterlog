import { c as Route$6, s as signupFn } from './router-bujGOfVM.mjs';
...
function SignupPage() {
  const { email: inviteEmail, invite: inviteToken } = Route$6.useSearch();
    ...
    children: /* @__PURE__ */ jsxs(Flex, {
      ...
      children: [
        ...
        inviteToken && /* @__PURE__ */ jsx(Callout.Root, {
          color: "blue",
          size: "1",
          children: /* @__PURE__ */ jsx(Callout.Text, { children: "You've been invited to join a team. Create an account to accept." })
        }),
        /* @__PURE__ */ jsxs("form", {
          onSubmit,
...
//# sourceMappingURL=signup-BnI9_bCS.mjs.map
