...
#
# All-in-one Raterlog image: builds the Rust API and the TanStack web client,
# then runs PostgreSQL, Cassandra, MailHog, the Rust API and the web server
# together from a single container (see docker/entrypoint.sh).
